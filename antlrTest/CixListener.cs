...
public interface ICixListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterVariableDeclarationWithInitializationStatement([NotNull] CixParser.VariableDeclarationWithInitializationStatementContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="CixParser.variableDeclarationWithInitializationStatement"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitVariableDeclarationWithInitializationStatement([NotNull] CixParser.VariableDeclarationWithInitializationStatementContext context);
	/// <summary>
